...
// Gauge Dark ThinkingIndicator: morphing needle glyph in the gauge gold with
// rotating status words, like a meter sweeping between readings.
//
// Usage:
//   <ThinkingIndicator />
...
function ThinkingIndicator({
  ...
  return (
    <div
      role="status"
      className={cn(
        "inline-flex items-center gap-2 px-3 py-2 text-primary",
        className
      )}
      {...props}
    >
