    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="relative mt-1.5">
        <input
          ...
          {...fieldProps}
          className={`h-10 w-full rounded-lg border-2 pl-3 pr-9 text-[13px] text-foreground outline-none transition-[background-color,border-color,box-shadow] duration-150 placeholder:text-muted-foreground/70 focus-visible:outline-none disabled:opacity-50 ${
            invalid
              ? "border-destructive bg-card"
              : "border-border bg-input focus:border-ring focus:bg-card"
          }`}
        />
