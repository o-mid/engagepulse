...
export function SegmentedControl({
  ...
  return (
    <div
      role="radiogroup"
      aria-label={label}
      className={`relative inline-block select-none rounded-lg border border-border bg-muted p-[3px] ${className}`}
    >
      <div
        ...
        >
          {options.map((option, i) => (
            <button
              ...
              className="cursor-default rounded-md outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
            >
