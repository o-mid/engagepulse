    ...
    >
      <div className="relative">
        <motion.div
          ...
          className="overflow-hidden overscroll-contain rounded-md outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
        >
        ...
        <motion.div
          ...
          className="pointer-events-none absolute inset-x-0 bottom-0 h-9 bg-gradient-to-t from-background to-background/0"
        />
      </div>
      <div className="mt-2 flex h-8 items-center">
        ...
        <button
          ...
          className={`inline-flex h-8 select-none items-center gap-2 rounded-md border border-border bg-card px-2.5 text-[12.5px] font-medium text-foreground outline-none transition-[border-color,box-shadow] duration-150 hover:border-foreground/30 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0 ${
