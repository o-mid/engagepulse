...
// Gauge Dark Tooltip: a small readout chip on the floating layer.
// Same popover material + --shadow-pop as every other floating surface.
  ...
  <TooltipPrimitive.Portal>
    ...
    >
      <TooltipPrimitive.Popup
        ...
        className={cn(
          "z-50 overflow-hidden rounded-md border border-border bg-popover px-3 py-1.5 text-xs text-popover-foreground shadow-[var(--shadow-pop)]",
