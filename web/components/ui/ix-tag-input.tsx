...
// TagInput: chip-based tag field with keyboard removal, paste splitting, and rejection feedback. Restyled onto the
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <ul
        ...
        className="relative flex max-h-[116px] min-h-10 list-none flex-wrap items-center gap-1.5 overflow-y-auto overscroll-contain rounded-lg border-2 border-border bg-muted p-[4px] shadow-inner transition-[background-color,border-color,box-shadow] duration-150 focus-within:border-ring focus-within:bg-card focus-within:shadow-none"
      >
          ...
          {rows.map(({ tag, key }, index) => {
            ...
            return (
              <motion.li
                ...
                className={`flex h-6 max-w-full shrink-0 select-none items-center gap-1 rounded-md border pl-2 pr-1.5 text-[12.5px] transition-[background-color,border-color,box-shadow,color] duration-150 ${
                  lit
              ...
              >
                ...
                <button
                  ...
                  className={`-mr-0.5 grid size-[14px] shrink-0 place-items-center rounded-sm transition-colors duration-150 ${
                    lit
