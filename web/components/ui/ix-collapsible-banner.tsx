      ...
      >
        ...
        >
          <div className="flex items-center gap-2.5 p-2.5">
            <span
              aria-hidden="true"
              className="grid size-[26px] shrink-0 place-items-center rounded-md bg-muted text-muted-foreground"
            >
              {icon ?? NOTICE_GLYPH}
            </span>
            ...
            {hasBody ? (
              <button
                ...
                className="group flex min-w-0 flex-1 items-center gap-2 rounded-md text-left outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
              >
                <span
                  id={titleId}
            ...
            {dismissible ? (
              <button
                ...
                className="grid size-[26px] shrink-0 place-items-center rounded-md text-muted-foreground/70 transition-colors duration-150 hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
              >
                {CLOSE}
              </button>
            ) : null}
