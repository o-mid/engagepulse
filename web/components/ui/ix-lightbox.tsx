...
>({
  ...
  const bind = {
    onPointerDown: (e: React.PointerEvent) => {
      ...
      const content = contentRef.current;
      onContent.current =
        content !== null && e.target instanceof Node && content.contains(e.target);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute inset-0 overflow-hidden outline-none select-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring ${
      ...
      >
        <p
          id={titleId}
          className="pointer-events-auto max-w-[65%] truncate rounded-md border border-border bg-card px-2.5 py-1.5 text-[12.5px] text-card-foreground"
        >
          {caption ?? alt}
        </p>
