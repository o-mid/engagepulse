      ...
      {showSkip ? (
        <div className="mt-2.5 flex justify-end">
          <button
            ...
            className="inline-grid h-7 place-items-center rounded-md border border-border px-2.5 text-[11.5px] font-medium text-muted-foreground transition-colors duration-150 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
          >
            <motion.span
              aria-hidden
