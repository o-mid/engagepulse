...
// TreeView: keyboard-navigable file tree with animated expand/collapse and typeahead. Restyled onto the
...
export function TreeView({
      ...
      return (
        <li key={node.id} role="none">
          <div
            ...
            className={`flex h-7 cursor-default select-none items-center gap-1 rounded-md px-1.5 outline-none transition-colors duration-150 focus-visible:bg-[var(--ring)]/10 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring ${
              isSelected
  ...
  return (
    <div
      className={`rounded-lg border border-border bg-card p-[5px] shadow-sm ${className}`}
    >
